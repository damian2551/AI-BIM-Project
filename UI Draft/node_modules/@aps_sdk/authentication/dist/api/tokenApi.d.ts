...
import { RequestArgs, BaseApi } from '@aps_sdk/authentication/dist/base';
import { GrantType } from '@aps_sdk/authentication/dist/model';
import { IntrospectToken } from '@aps_sdk/authentication/dist/model';
import { Jwks } from '@aps_sdk/authentication/dist/model';
import { OidcSpec } from '@aps_sdk/authentication/dist/model';
import { ResponseType } from '@aps_sdk/authentication/dist/model';
import { Scopes } from '@aps_sdk/authentication/dist/model';
import { TokenTypeHint } from '@aps_sdk/authentication/dist/model';
/**
...
export declare const TokenApiAxiosParamCreator: (apsConfiguration?: IApsConfiguration) => {
     ...
     * @throws {RequiredError}
     */
    fetchToken: (authorization?: string, grantType?: GrantType, code?: string, redirectUri?: string, codeVerifier?: string, refreshToken?: string, scopes?: Array<Scopes>, clientId?: string, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    revoke: (token: string, tokenTypeHint: TokenTypeHint, authorization?: string, clientId?: string, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const TokenApiFp: (sdkManager?: SdkManager) => {
     ...
     * @throws {RequiredError}
     */
    fetchToken(authorization?: string, grantType?: GrantType, code?: string, redirectUri?: string, codeVerifier?: string, refreshToken?: string, scopes?: Array<Scopes>, clientId?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Returns a set of public keys in the JSON Web Key Set (JWKS) format.  Public keys returned by this operation can be used to validate the asymmetric JWT signature of an access token without making network calls. It can be used to validate both two-legged access tokens and three-legged access tokens.   See the Developer\'s Guide topic on `Asymmetric Signing </en/docs/oauth/v2/developers_guide/asymmetric-encryption/>`_ for more information.
     * @summary Get JWKS
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    revoke(token: string, tokenTypeHint: TokenTypeHint, authorization?: string, clientId?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
};
/**
 * TokenApi - interface
 * @export
