import { ExtractorVersion } from '@aps_sdk/model-derivative/dist/model/extractorVersion';
import { MaterialMode } from '@aps_sdk/model-derivative/dist/model/materialMode';
import { Model2dView } from '@aps_sdk/model-derivative/dist/model/model2dView';
/**
 * Advanced options for Revit inputs.
 * @export
 * @interface JobPayloadFormatSVFAdvancedRVT
 */
export interface JobPayloadFormatSVFAdvancedRVT {
    /**
     *
     * @type {Model2dView}
     * @memberof JobPayloadFormatSVFAdvancedRVT
     */
    '2dviews'?: Model2dView;
    /**
     *
