import { ApiResponse, ApsServiceRequestConfig, BaseClient, IAuthenticationProvider, SdkManager } from "@aps_sdk/autodesk-sdkmanager";
import { DerivativesApi, InformationalApi, JobsApi, ManifestApi, MetadataApi, ThumbnailsApi } from "@aps_sdk/model-derivative/dist/api";
import { DeleteManifest, DerivativeDownload, Height, Job, JobPayload, Manifest, ModelViews, ObjectTree, Properties, Region, SpecificProperties, SpecificPropertiesPayload, SpecifyReferences, SpecifyReferencesPayload, SupportedFormats, Width, XAdsDerivativeFormat } from "@aps_sdk/model-derivative/dist/model";
/**
