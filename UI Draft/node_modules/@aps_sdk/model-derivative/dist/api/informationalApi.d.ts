...
import { SupportedFormats } from '@aps_sdk/model-derivative/dist/model';
/**
...
export declare const InformationalApiFp: (sdkManager?: SdkManager) => {
     ...
     * @throws {RequiredError}
     */
    getFormats(accessToken: string, ifModifiedSince?: string, acceptEncoding?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SupportedFormats>>;
};
/**
