...
import { Job } from '@aps_sdk/model-derivative/dist/model';
import { JobPayload } from '@aps_sdk/model-derivative/dist/model';
import { Region } from '@aps_sdk/model-derivative/dist/model';
import { SpecifyReferences } from '@aps_sdk/model-derivative/dist/model';
import { SpecifyReferencesPayload } from '@aps_sdk/model-derivative/dist/model';
...
export declare const JobsApiAxiosParamCreator: (apsConfiguration?: IApsConfiguration) => {
     ...
     */
    specifyReferences: (accessToken: string, urn: string, region?: Region, specifyReferencesPayload?: SpecifyReferencesPayload, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    startJob: (accessToken: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, region?: Region, jobPayload?: JobPayload, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const JobsApiFp: (sdkManager?: SdkManager) => {
     ...
     * @throws {RequiredError}
     */
    specifyReferences(accessToken: string, urn: string, region?: Region, specifyReferencesPayload?: SpecifyReferencesPayload, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SpecifyReferences>>;
    /**
     * Creates a job to translate the specified source design to another format, generating derivatives of the source design. You can optionaly:  - Extract selected parts of a design and export the set of geometries in OBJ format. - Generate different-sized thumbnails.  When the translation job runs, details about the process and generated derivatives are logged to a JSON file known as a manifest. This manifest is typically created during the first translation of a source design. Subsequently, the system updates the same manifest whenever a translation is performed for that design.   If necessary, you can set the ``x-ads-force`` parameter to ``true``. Then, the system will delete the existing manifest and create a new one. However, be aware that doing so will also delete all previously generated derivatives.
     * @summary Create Translation Job
     * @param {boolean} [xAdsForce] &#x60;&#x60;true&#x60;&#x60;: Forces the system to parse property data all over again. Use this option to retrieve an object tree when previous attempts have failed.  &#x60;&#x60;false&#x60;&#x60;: (Default) Use previously parsed property data to extract the object tree.
     ...
     * @throws {RequiredError}
     */
    startJob(accessToken: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, region?: Region, jobPayload?: JobPayload, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Job>>;
};
/**
 * JobsApi - interface
 * @export
