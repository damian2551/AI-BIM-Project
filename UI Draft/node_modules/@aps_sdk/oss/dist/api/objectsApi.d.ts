...
import { RequestArgs, BaseApi } from '@aps_sdk/oss/dist/base';
import { Access } from '@aps_sdk/oss/dist/model';
import { Region } from '@aps_sdk/oss/dist/model';
import { With } from '@aps_sdk/oss/dist/model';
import { BatchcompleteuploadObject } from '@aps_sdk/oss/dist/model/batchcompleteuploadObject';
import { BatchcompleteuploadResponse } from '@aps_sdk/oss/dist/model/batchcompleteuploadResponse';
import { Batchsigneds3downloadObject } from '@aps_sdk/oss/dist/model/batchsigneds3downloadObject';
import { Batchsigneds3downloadResponse } from '@aps_sdk/oss/dist/model/batchsigneds3downloadResponse';
import { Batchsigneds3uploadObject } from '@aps_sdk/oss/dist/model/batchsigneds3uploadObject';
import { Batchsigneds3uploadResponse } from '@aps_sdk/oss/dist/model/batchsigneds3uploadResponse';
import { BucketObjects } from '@aps_sdk/oss/dist/model/bucketObjects';
import { Completes3uploadBody } from '@aps_sdk/oss/dist/model/completes3uploadBody';
import { CreateObjectSigned } from '@aps_sdk/oss/dist/model/createObjectSigned';
import { CreateSignedResource } from '@aps_sdk/oss/dist/model/createSignedResource';
import { ObjectDetails } from '@aps_sdk/oss/dist/model/objectDetails';
import { ObjectFullDetails } from '@aps_sdk/oss/dist/model/objectFullDetails';
import { Signeds3downloadResponse } from '@aps_sdk/oss/dist/model/signeds3downloadResponse';
import { Signeds3uploadResponse } from '@aps_sdk/oss/dist/model/signeds3uploadResponse';
/**
 * ObjectsApi - axios parameter creator
 * @export
 */
export declare const ObjectsApiAxiosParamCreator: (apsConfiguration?: IApsConfiguration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    copyTo: (accessToken: string, bucketKey: string, objectKey: string, newObjName: string, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createSignedResource: (accessToken: string, bucketKey: string, objectKey: string, access?: Access, useCdn?: boolean, createSignedResource?: CreateSignedResource, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteObject: (accessToken: string, bucketKey: string, objectKey: string, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteSignedResource: (accessToken: string, hash: string, xAdsRegion?: Region, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getObjectDetails: (accessToken: string, bucketKey: string, objectKey: string, ifModifiedSince?: string, _with?: With, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSignedResource: (accessToken: string, hash: string, range?: string, ifNoneMatch?: string, ifModifiedSince?: string, acceptEncoding?: string, region?: Region, responseContentDisposition?: string, responseContentType?: string, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    signedS3Upload: (accessToken: string, bucketKey: string, objectKey: string, parts?: number, firstPart?: number, uploadKey?: string, minutesExpiration?: number, useAcceleration?: boolean, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    uploadSignedResource: (accessToken: string, hash: string, contentLength: number, body: File, contentType?: string, contentDisposition?: string, xAdsRegion?: Region, ifMatch?: string, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    uploadSignedResourcesChunk: (accessToken: string, hash: string, contentRange: string, sessionId: string, body: File, contentType?: string, contentDisposition?: string, xAdsRegion?: Region, options?: ApsServiceRequestConfig) => Promise<RequestArgs>;
};
/**
 * ObjectsApi - functional programming interface
 * @export
 */
export declare const ObjectsApiFp: (sdkManager?: SdkManager) => {
    /**
     * Requests OSS to start reconstituting the set of objects that were uploaded using signed S3 upload URLs. You must call this operation only after all the objects have been uploaded.   You can specify up to 25 objects in this operation.
     * @summary Complete Batch Upload to S3 Signed URLs
     * @param {string} bucketKey The bucket key of the bucket that contains the objects you are operating on.
     ...
     * @throws {RequiredError}
     */
    copyTo(accessToken: string, bucketKey: string, objectKey: string, newObjName: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ObjectDetails>>;
    /**
     * Generates a signed URL that can be used to download or upload an object within the specified expiration time. If the object the signed URL points to is deleted or expires before the signed URL expires, the signed URL will no longer be valid.  In addition to this operation that generates OSS signed URLs, OSS provides operations to generate S3 signed URLs. S3 signed URLs allow direct upload/download from S3 but are restricted to bucket owners. OSS signed URLs also allow upload/download and can be configured for access by other applications, making them suitable for sharing objects across applications.  Only the application that owns the bucket containing the object can call this operation.
     * @summary Generate OSS Signed URL
     * @param {string} bucketKey The bucket key of the bucket that contains the objects you are operating on.
     ...
     * @throws {RequiredError}
     */
    createSignedResource(accessToken: string, bucketKey: string, objectKey: string, access?: Access, useCdn?: boolean, createSignedResource?: CreateSignedResource, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateObjectSigned>>;
    /**
     * Deletes an object from the bucket.
     * @summary Delete Object
     * @param {string} bucketKey The bucket key of the bucket that contains the objects you are operating on.
     ...
     * @throws {RequiredError}
     */
    deleteObject(accessToken: string, bucketKey: string, objectKey: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Delete an object using an OSS signed URL to access it.  Only applications that own the bucket containing the object can call this operation.
     * @summary Delete Object Using Signed URL
     * @param {string} hash The ID component of the signed URL.  **Note:** The signed URL returned by [Generate OSS Signed URL](/en/docs/data/v2/reference/http/signedresources-:id-GET/) contains &#x60;&#x60;hash&#x60;&#x60; as a URI parameter.
     ...
     * @throws {RequiredError}
     */
    deleteSignedResource(accessToken: string, hash: string, xAdsRegion?: Region, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Returns detailed information about the specified object.
     * @summary Get Object Details
     * @param {string} bucketKey The bucket key of the bucket that contains the objects you are operating on.
     ...
     * @throws {RequiredError}
     */
    getObjectDetails(accessToken: string, bucketKey: string, objectKey: string, ifModifiedSince?: string, _with?: With, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ObjectFullDetails>>;
    /**
     * Returns a list objects in the specified bucket.   Only the application that owns the bucket can call this operation. All other applications that call this operation will receive a \"403 Forbidden\" error.
     * @summary List Objects
     * @param {string} bucketKey The bucket key of the bucket that contains the objects you are operating on.
     ...
     * @throws {RequiredError}
     */
    getSignedResource(accessToken: string, hash: string, range?: string, ifNoneMatch?: string, ifModifiedSince?: string, acceptEncoding?: string, region?: Region, responseContentDisposition?: string, responseContentType?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>>;
    /**
     * Gets a signed URL to download an object directly from S3, bypassing OSS servers. This signed URL expires in 2 minutes by default, but you can change this duration if needed.  You must start the download before the signed URL expires. The download itself can take longer. If the download fails after the validity period of the signed URL has elapsed, you can call this operation again to obtain a fresh signed URL.  Only applications that have read access to the object can call this operation.     You can use range headers with the signed download URL to download the object in chunks. This ability lets you download chunks in parallel, which can result in faster downloads.  If the object you want to download was uploaded in chunks and is still assembling on OSS, you will receive multiple S3 URLs instead of just one. Each URL will point to a chunk. If you prefer to receive a single URL, set the ``public-resource-fallback`` query parameter to ``true``. This setting will make OSS fallback to returning a single signed OSS URL, if assembling is still in progress.   In addition to this operation that generates S3 signed URLs, OSS provides an operation to generate OSS signed URLs. S3 signed URLs allow direct upload/download from S3 but are restricted to bucket owners. OSS signed URLs also allow upload/download and can be configured for access by other applications, making them suitable for sharing objects across applications.
     * @summary Generate Signed S3 Download URL
     * @param {string} bucketKey The bucket key of the bucket that contains the objects you are operating on.
     ...
     * @throws {RequiredError}
     */
    signedS3Upload(accessToken: string, bucketKey: string, objectKey: string, parts?: number, firstPart?: number, uploadKey?: string, minutesExpiration?: number, useAcceleration?: boolean, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Signeds3uploadResponse>>;
    /**
     * Replaces an object that already exists on OSS, using an OSS signed URL.   The signed URL must fulfil the following conditions:  - The signed URL is valid (it has not expired as yet). - It was generated with ``write`` or ``readwrite`` for the ``access`` parameter.
     * @summary Replace Object Using Signed URL
     * @param {string} hash The ID component of the signed URL.  **Note:** The signed URL returned by [Generate OSS Signed URL](/en/docs/data/v2/reference/http/signedresources-:id-GET/) contains &#x60;&#x60;hash&#x60;&#x60; as a URI parameter.
     ...
     * @throws {RequiredError}
     */
    uploadSignedResource(accessToken: string, hash: string, contentLength: number, body: File, contentType?: string, contentDisposition?: string, xAdsRegion?: Region, ifMatch?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ObjectDetails>>;
    /**
     * Performs a resumable upload using an OSS signed URL. Use this operation to upload an object in chunks.  **Note:** The signed URL returned by [Generate OSS Signed URL](/en/docs/data/v2/reference/http/signedresources-:id-GET/) contains the ``hash`` as a URI parameter.
     * @summary Upload Object Using Signed URL
     * @param {string} hash The ID component of the signed URL.  **Note:** The signed URL returned by [Generate OSS Signed URL](/en/docs/data/v2/reference/http/signedresources-:id-GET/) contains &#x60;&#x60;hash&#x60;&#x60; as a URI parameter.
     ...
     * @throws {RequiredError}
     */
    uploadSignedResourcesChunk(accessToken: string, hash: string, contentRange: string, sessionId: string, body: File, contentType?: string, contentDisposition?: string, xAdsRegion?: Region, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ObjectDetails>>;
};
/**
 ...
 * @extends {BaseApi}
 */
export declare class ObjectsApi extends BaseApi implements ObjectsApiInterface {
    private logger;
    /**
     * Requests OSS to start reconstituting the set of objects that were uploaded using signed S3 upload URLs. You must call this operation only after all the objects have been uploaded.   You can specify up to 25 objects in this operation.
     * @summary Complete Batch Upload to S3 Signed URLs
